...
export const fedeApi = {
  ...
  async getConfiguration() {
    try {
      const response = await api.get('/fede/admin/configuration');
      return response.data;
    } catch (error) {
      console.error('Error obteniendo configuración:', error);
      throw error;
  ...
  async updateConfiguration(config) {
    try {
      const response = await api.put('/fede/admin/configuration', config);
      return response.data;
    } catch (error) {
      console.error('Error actualizando configuración:', error);
      throw error;
  ...
  async startTraining(config) {
    try {
      const response = await api.post('/fede/admin/training/start', config);
      return response.data;
    } catch (error) {
  ...
  async stopTraining() {
    try {
      const response = await api.post('/fede/admin/training/stop');
      return response.data;
    } catch (error) {
  ...
  async exportTrainingData() {
    try {
      const response = await api.get('/fede/admin/training/export');
      return response.data;
    } catch (error) {
      console.error('Error exportando datos de entrenamiento:', error);
      throw error;
    }
  },
  ...
  async getModelVersions() {
    try {
      const response = await api.get('/fede/admin/models/versions');
      return response.data;
    } catch (error) {
  ...
  async deployModel(versionId) {
    try {
      const response = await api.post(`/fede/admin/models/${versionId}/deploy`);
      return response.data;
    } catch (error) {
  ...
  async testMessage(message) {
    try {
      const response = await api.post('/fede/admin/test-message', { message });
      return response.data;
    } catch (error) {
      console.error('Error probando mensaje:', error);
      throw error;
